...
xhr2.send(
  `event=get_hallConfig&timestamp=${selectedSession.timestamp}&hallId=${selectedSession.seanceHallid}&seanceId=${selectedSession.seancesId}`
);
xhr2.addEventListener("load", () => {
  ...
  document.addEventListener("click", (e) => {
    ...
    e.target.parentElement.classList.contains("conf-step__row")) {
